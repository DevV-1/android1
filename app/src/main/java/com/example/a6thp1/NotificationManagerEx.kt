    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnNotify.setOnClickListener {
            ...
            audioAttr = AudioAttributes.Builder()
                ...
                .build()
            remoteCollapsedViews = RemoteViews(packageName, R.layout.notification_extended_view)
            remoteExpandedViews = RemoteViews(packageName, R.layout.notification_compact_view)
            myNotificationChannel()
            remoteInput = RemoteInput.Builder(myKey).setLabel("Replying...")
                .build()
            val action: Notification.Action =
                Notification.Action.Builder(R.drawable.ic_launcher_foreground, "Reply", pendingIntent)
    ...
    private fun myNotificationChannel() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            builder = Notification.Builder(this,channelId)
                ...
                .setLargeIcon(BitmapFactory.decodeResource(this.resources,R.drawable.ic_baseline_home_24))
